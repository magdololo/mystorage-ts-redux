        ...
        <>
            ...
            <div className="max-w-xs text-center text-gray pt-2 pb-4 px-6 mx-auto">
                <button type="button"
                        ...
                        data-mdb-ripple="true" data-mdb-ripple-color="light" onClick={()=>toggleEdit()}>{toggleValue ? t("categories.CategoryList.categoryListButton") : t("categories.CategoryList.editButton")}
