...
export const CategoryList = () => {
                   ...
                   <div className={"h-auto flex flex-col relative" + (toggleSwitch ? " bg-black bg-opacity-90 " : "")} key={category?.id}>
                       ...
                       {toggleSwitch &&
                           <FontAwesomeIcon
                               ...
                               data-testid={'faPen'} icon={faPen} onClick={() => {
                       ...
                       {toggleSwitch &&
                           <FontAwesomeIcon
                               ...
                               data-testid={'faXmark'} icon={faXmark}
                               onClick={() => chooseDeleteCategory(category as Category)}/>
                       }
                   </div>
                )
        )
                ...
                <MainBox>
                    ...
                    {!toggleSwitch &&
                        <div
                            ...
                            onClick={handleShownAddCategoryModal}>
                            <img src="https://placehold.jp/ffffff/ffffff/1280x900.png" alt={"placeholder"}
                                 className="bg-cover"/>
    ...
    return (
        <>
            ...
            {content}
            <Modal
                className={"addCategory-modal"}
                isShown={isShownAddCategoryModal}
                hide={handleCloseAddCategoryModal}
                modalHeaderText={!toggleSwitch ? modalAddHeader : modalEditHeader}
                modalContent={!toggleSwitch ? <AddCategoryForm closeAddCategoryModal={handleCloseAddCategoryModal}/> :
                    <EditCategoryForm closeAddCategoryModal={handleCloseAddCategoryModal}/>}
            />
            <Modal isShown={isShownDeleteCategoryModal} hide={() => handleCloseDeleteCategoryModal()}
                   modalHeaderText={""} modalContent={contentModalDeleteCategory}/>
